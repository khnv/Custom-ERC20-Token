...
contract MyToken is ERC20, ERC20Pausable, AccessControl {
     ...
     */
    event TransferFeeCollected(address indexed from, address indexed to, uint256 amount, uint256 feeAmount, uint256 netAmount);
     ...
     */
    function burn(uint amount) external onlyRole(BURNER_ROLE) {
